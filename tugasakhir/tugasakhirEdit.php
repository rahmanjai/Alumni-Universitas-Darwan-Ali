...
?>
  ...
  <?php
	...
	if (isset($_GET['id_tugas_akhir'])){
        ...
        ON tb_tugas_akhir.npm=tb_mahasiswa.npm
...
<form name="editDosen" action="yudisiumEditProses.php" method="post">
  <table cellpadding="3" cellspacing="0" align="center">
   <tr>
    <td>ID Yudisium</td>
    <td>:</td>
    <td><input type="text" name="id_tugas_akhir" value="<?php echo $row['id_tugas_akhir']; ?>" size="6" required></td>
   </tr>
    <tr>
    <td>NPM</td>
    <td>:</td>
    <td><input type="text" value="<?php echo $row['npm']; ?>" name="npm" size="13" required></td>
   </tr>
    <tr>
    <td>Jenis Keluar</td>
    <td>:</td>
