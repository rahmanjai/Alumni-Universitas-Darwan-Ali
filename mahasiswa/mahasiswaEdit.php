...
?>
  ...
  <?php
	...
	include "../temp/selectMahasiswa.php";
	if (isset($_GET['npm'])){
...
<form name="editAlumni" action="mahasiswaEditProses.php" method="post">
  ...
  <tr>
    ...
    <td>
		<select name="nid">
            <?php 
			include "../list/listDosenSelect.php"; 
			?>
		</select>
	</td>
   </tr>
  <tr>
    ...
    <td>
		<select name="id_prodi">
            <?php 
			include "../list/listProdiSelect.php"; 
			?>
		</select>
	</td>
   </tr>
